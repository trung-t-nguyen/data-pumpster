...
| UC-04 | [Stream Import Progress (SSE)](use-cases/uc-04-progress-stream.md) | ✅ Complete — [PR #5](https://github.com/trung-t-nguyen/data-pumpster/pull/5) |
| UC-05 | [View Import History](use-cases/uc-05-import-history.md) | ✅ Complete — [PR #6](https://github.com/trung-t-nguyen/data-pumpster/pull/6) |
